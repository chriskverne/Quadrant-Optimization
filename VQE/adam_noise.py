...
if __name__ == "__main__":
    ...
    calib = {
        "T1": [28e-6, 31e-6, 25e-6, 33e-6, 29e-6, 30e-6],   # per-qubit
        "T2": [18e-6, 21e-6, 17e-6, 20e-6, 19e-6, 18e-6],
        "t_1q": 35e-9,
        "t_2q": 220e-9,
        "t_idle": 60e-9,
        "p1q_dep": 8e-4,       # 1q depolarizing per gate
        "p2q_dep": 0.015,      # 2q depolarizing per entangler
        "p_ro": [0.02, 0.015, 0.02, 0.018, 0.022, 0.02],  # readout assignment error
    }
